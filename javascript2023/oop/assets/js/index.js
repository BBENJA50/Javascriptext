...
function voegToe() {
    ...
    var studentNummer = document.getElementById("inputStudentNummer").value;

    var student = new Student(voorNaam, naam, studentNummer);

    studenten.push(student);
    console.log(studenten);

    //reset formulier naar lege velden
...
function toonStudenten(){
    ...
    studenten.forEach((currentElement) => {
        let li = document.createElement("li");
        inhoud = currentElement.toonStudentInfo();
        li.textContent = inhoud;
